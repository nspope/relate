...
prior_mixture = prior_class.to_gamma_mixture(3, population_size=ne_est)
...
ts_org.dump(f"sim_varne2/chr1.tsorig.trees")
ts_mix = tsdate.date(ts, mutation_rate=mu, priors=prior, global_prior=False, global_distribution=prior_mixture, method="variational_gamma", max_iterations=30, progress=True, max_shape=100)
ts_mix.dump(f"sim_varne2/chr1.tsdate.trees")
